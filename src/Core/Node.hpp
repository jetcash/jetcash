...
static const float DB_COMMIT_PERIOD_JETCASHD    = 310;  // 5 minutes sounds good compromise
...
public:
	...
	bool on_wallet_sync3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::jetcashd::SyncBlocks::Request &&, api::jetcashd::SyncBlocks::Response &);
	bool on_sync_mempool3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::jetcashd::SyncMemPool::Request &&, api::jetcashd::SyncMemPool::Response &);

	api::jetcashd::GetStatus::Response create_status_response3() const;
	// json_rpc_node
	bool on_get_status3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::jetcashd::GetStatus::Request &&, api::jetcashd::GetStatus::Response &);
	bool on_get_random_outputs3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::jetcashd::GetRandomOutputs::Request &&, api::jetcashd::GetRandomOutputs::Response &);
	bool handle_send_transaction3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::jetcashd::SendTransaction::Request &&, api::jetcashd::SendTransaction::Response &);
	bool handle_check_send_proof3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::jetcashd::CheckSendProof::Request &&, api::jetcashd::CheckSendProof::Response &);
	bool on_getblocktemplate(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::jetcashd::GetBlockTemplate::Request &&r, api::jetcashd::GetBlockTemplate::Response &);
	void getblocktemplate(
	    const api::jetcashd::GetBlockTemplate::Request &, api::jetcashd::GetBlockTemplate::Response &);
	bool on_get_currency_id(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::jetcashd::GetCurrencyId::Request &&, api::jetcashd::GetCurrencyId::Response &);
	bool on_submitblock(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::jetcashd::SubmitBlock::Request &&, api::jetcashd::SubmitBlock::Response &);
	bool on_get_last_block_header(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::jetcashd::GetLastBlockHeader::Request &&, api::jetcashd::GetLastBlockHeader::Response &);
	bool on_get_block_header_by_hash(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::jetcashd::GetBlockHeaderByHash::Request &&, api::jetcashd::GetBlockHeaderByHash::Response &);
	bool on_get_block_header_by_height(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::jetcashd::GetBlockHeaderByHeight::Request &&, api::jetcashd::GetBlockHeaderByHeight::Response &);
...
protected:
	...
	struct LongPollClient {
		...
		api::jetcashd::GetStatus::Request original_get_status;
	};
	...
	class P2PClientJetcash : public P2PClientBasic {
		Node *const m_node;
...
#endif
	public:
		explicit P2PClientJetcash(Node *node, bool incoming, D_handler d_handler)
	...
	std::unique_ptr<P2PClient> client_factory(bool incoming, P2PClient::D_handler d_handler) {
		return std::make_unique<P2PClientJetcash>(this, incoming, d_handler);
	}
	...
	class DownloaderV11 {  // torrent-style sync&download from legacy v1 clients
		...
		std::map<P2PClientJetcash *, size_t> m_good_clients;  // -> # of downloading blocks
		size_t total_downloading_blocks = 0;
		std::list<P2PClientJetcash *> m_who_downloaded_block;
		P2PClientJetcash *m_chain_client = nullptr;
		...
		struct DownloadCell {
			...
			P2PClientJetcash *downloading_client = nullptr;
	...
	public:
		...
		void on_connect(P2PClientJetcash *);
		void on_disconnect(P2PClientJetcash *);
		const std::map<P2PClientJetcash *, size_t> &get_good_clients() const { return m_good_clients; }
		void on_msg_notify_request_chain(P2PClientJetcash *, const NOTIFY_RESPONSE_CHAIN_ENTRY::request &);
		void on_msg_notify_request_objects(P2PClientJetcash *, const NOTIFY_RESPONSE_GET_OBJECTS::request &);
	...
	void sync_transactions(P2PClientJetcash *);
