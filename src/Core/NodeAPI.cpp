...
bool Node::on_getblocktemplate(http::Client *who, http::RequestData &&raw_request, json_rpc::Request &&raw_js_request,
    api::jetcashd::GetBlockTemplate::Request &&req, api::jetcashd::GetBlockTemplate::Response &res) {
	api::jetcashd::GetStatus::Request sta;
...
void Node::getblocktemplate(const api::jetcashd::GetBlockTemplate::Request &req,
    api::jetcashd::GetBlockTemplate::Response &res) {
...
bool Node::on_get_currency_id(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::jetcashd::GetCurrencyId::Request && /*req*/, api::jetcashd::GetCurrencyId::Response &res) {
	res.currency_id_blob = m_block_chain.get_genesis_bid();
	return true;
}

bool Node::on_submitblock(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::jetcashd::SubmitBlock::Request &&req, api::jetcashd::SubmitBlock::Response &res) {
...
bool Node::on_get_last_block_header(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::jetcashd::GetLastBlockHeader::Request &&,
    api::jetcashd::GetLastBlockHeader::Response &response) {
...
bool Node::on_get_block_header_by_hash(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::jetcashd::GetBlockHeaderByHash::Request &&request,
    api::jetcashd::GetBlockHeaderByHash::Response &response) {
...
bool Node::on_get_block_header_by_height(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::jetcashd::GetBlockHeaderByHeight::Request &&request,
    api::jetcashd::GetBlockHeaderByHeight::Response &response) {
	Hash block_hash;
	
	if (!m_block_chain.read_chain(request.height, block_hash)) {
	...
	if (!m_block_chain.read_header(block_hash, response.block_header)) {
		throw json_rpc::Error{ CORE_RPC_ERROR_CODE_TOO_BIG_HEIGHT,
		    std::string("To big height: ") + common::to_string(request.height) + ", current blockchain height = " + common::to_string(m_block_chain.get_tip_height())};
	}
