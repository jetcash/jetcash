...
// bool - Bool
// Amount, SignedAmount, Height, Timestamp, UnlockMoment, Difficulty, (u)int - Number. jetcash does not use fractional
...
// jetcash does not use Null, you should specify empty Array as [], empty string as "", empty Object as {}
namespace jetcash {
namespace api {
...
enum return_code {
	JETCASHD_DATABASE_ERROR    = 101,  // We hope we are out of disk space, otherwise blockchain DB is corrupted.
...
struct GetStatus {
	...
	struct Request {
		...
		std::string
		    lower_level_error;  // Problems on lower levels (like jetcashd errors in walletd status). Empty - no errors
...
struct CreateTransaction {
	...
	struct Request {
		...
		std::vector<std::string>
			spend_addresses;  		// If this is not empty, will spend (and optimize) outputs for this address to get
		...
		SignedAmount fee_per_coin = 0;   // Fee of created transaction will be close to the size of tx * fee_per_coin.
	...
	struct Response {
		...
		api::Transaction transaction;     // contains only fee, hash, block_index and anonymity for now...
...
// These messages encoded in JSON can be sent via http url /json_rpc3 to jetcashd rpc address:port
...
struct SyncBlocks {  // Used by walletd, block explorer, etc to sync to jetcashd
	...
	struct SyncBlock {  // Signatures are checked by jetcashd so usually they are of no interest
		api::BlockHeader header;
		jetcash::BlockTemplate bc_header;  // the only method returning actual BlockHeader from blockchain, not api::BlockHeader
		std::vector<jetcash::TransactionPrefix> bc_transactions;  // the only method returning actual Transaction from blockchain, not api::Transaction
...
struct SyncMemPool {  // Used by walletd sync process
	...
	struct Response {
		...
		std::vector<jetcash::TransactionPrefix> added_bc_transactions;  // New raw transactions in pool
...
struct BlockHeader : public api::BlockHeader {
...
struct GetBlockHeaderByHash{
	...
	typedef GetLastBlockHeader::Response Response;
};
...
void ser_members(jetcash::api::EmptyStruct &v, ISeria &s);
void ser_members(jetcash::api::Output &v, ISeria &s);
void ser_members(jetcash::api::BlockHeader &v, ISeria &s);
void ser_members(jetcash::api::Transfer &v, ISeria &s);
void ser_members(jetcash::api::Transaction &v, ISeria &s);
void ser_members(jetcash::api::Block &v, ISeria &s);
void ser_members(jetcash::api::Balance &v, ISeria &s);

void ser_members(jetcash::api::walletd::GetAddresses::Response &v, ISeria &s);
void ser_members(jetcash::api::walletd::GetViewKeyPair::Response &v, ISeria &s);
void ser_members(jetcash::api::walletd::CreateAddresses::Request &v, ISeria &s);
void ser_members(jetcash::api::walletd::CreateAddresses::Response &v, ISeria &s);
void ser_members(jetcash::api::walletd::GetBalance::Request &v, ISeria &s);
void ser_members(jetcash::api::walletd::GetBalance::Response &v, ISeria &s);
void ser_members(jetcash::api::walletd::GetUnspents::Request &v, ISeria &s);
void ser_members(jetcash::api::walletd::GetUnspents::Response &v, ISeria &s);
void ser_members(jetcash::api::walletd::GetTransfers::Request &v, ISeria &s);
void ser_members(jetcash::api::walletd::GetTransfers::Response &v, ISeria &s);
void ser_members(jetcash::api::walletd::CreateTransaction::Request &v, ISeria &s);
void ser_members(jetcash::api::walletd::CreateTransaction::Response &v, ISeria &s);
void ser_members(jetcash::api::walletd::CreateSendProof::Request &v, ISeria &s);
void ser_members(jetcash::api::walletd::CreateSendProof::Response &v, ISeria &s);
void ser_members(jetcash::api::walletd::GetTransaction::Request &v, ISeria &s);
void ser_members(jetcash::api::walletd::GetTransaction::Response &v, ISeria &s);

void ser_members(jetcash::api::jetcashd::GetStatus::Request &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::GetStatus::Response &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::SyncBlocks::Request &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::SyncBlocks::SyncBlock &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::SyncBlocks::Response &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::SyncMemPool::Request &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::SyncMemPool::Response &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::GetRandomOutputs::Request &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::GetRandomOutputs::Response &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::SendTransaction::Request &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::SendTransaction::Response &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::CheckSendProof::Request &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::CheckSendProof::Response &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::GetBlockTemplate::Request &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::GetBlockTemplate::Response &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::GetCurrencyId::Response &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::SubmitBlock::Request &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::SubmitBlock::Response &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::BlockHeader &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::GetLastBlockHeader::Response &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::GetBlockHeaderByHash::Request &v, ISeria &s);
void ser_members(jetcash::api::jetcashd::GetBlockHeaderByHeight::Request &v, ISeria &s);
